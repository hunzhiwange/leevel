...
ZEND_BEGIN_ARG_INFO_EX(arginfo_leevel_session_session_keepflash, 0, 0, 1)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_leevel_session_session_deleteflash, 0, 0, 1)
	ZEND_ARG_ARRAY_INFO(0, keys, 0)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(leevel_session_session_method_entry) {
	...
	PHP_ME(Leevel_Session_Session, keepFlash, arginfo_leevel_session_session_keepflash, ZEND_ACC_PUBLIC)
	PHP_ME(Leevel_Session_Session, getFlash, arginfo_leevel_session_session_getflash, ZEND_ACC_PUBLIC)
	PHP_ME(Leevel_Session_Session, deleteFlash, arginfo_leevel_session_session_deleteflash, ZEND_ACC_PUBLIC)
