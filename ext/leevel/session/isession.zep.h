...
ZEND_BEGIN_ARG_INFO_EX(arginfo_leevel_session_isession_keepflash, 0, 0, 1)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_leevel_session_isession_deleteflash, 0, 0, 1)
	ZEND_ARG_ARRAY_INFO(0, keys, 0)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(leevel_session_isession_method_entry) {
	...
	PHP_ABSTRACT_ME(Leevel_Session_ISession, keepFlash, arginfo_leevel_session_isession_keepflash)
	PHP_ABSTRACT_ME(Leevel_Session_ISession, getFlash, arginfo_leevel_session_isession_getflash)
	PHP_ABSTRACT_ME(Leevel_Session_ISession, deleteFlash, arginfo_leevel_session_isession_deleteflash)
