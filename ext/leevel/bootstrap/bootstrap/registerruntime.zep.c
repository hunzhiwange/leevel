...
PHP_METHOD(Leevel_Bootstrap_Bootstrap_RegisterRuntime, handle) {
	...
	zephir_array_fetch_long(&project, &args, 0, PH_NOISY, "leevel/bootstrap/bootstrap/registerruntime.zep", 55 TSRMLS_CC);
	zephir_update_property_zval(this_ptr, SL("project"), &project);
	test = 2 == ZEND_NUM_ARGS();
	if (!test) {
		ZVAL_LONG(&_0$$3, 32767);
		ZEPHIR_CALL_FUNCTION(NULL, "error_reporting", NULL, 63, &_0$$3);
		...
		ZEPHIR_CALL_FUNCTION(NULL, "set_error_handler", NULL, 49, &_1$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "set_exception_handler", NULL, 64, &_3$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "register_shutdown_function", NULL, 65, &_4$$3);
		zephir_check_call_status();
		...
		if (ZEPHIR_IS_STRING_IDENTICAL(&_5$$3, "production")) {
			...
			ZEPHIR_CALL_FUNCTION(NULL, "ini_set", NULL, 66, &_6$$4, &_7$$4);
			zephir_check_call_status();
		}
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Leevel_Bootstrap_Bootstrap_RegisterRuntime, setErrorHandle) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "error_reporting", NULL, 63);
	zephir_check_call_status();
	...
	zephir_check_call_status();
	zephir_throw_exception_debug(&_1, "leevel/bootstrap/bootstrap/registerruntime.zep", 92 TSRMLS_CC);
	ZEPHIR_MM_RESTORE();
	return;
...
PHP_METHOD(Leevel_Bootstrap_Bootstrap_RegisterRuntime, registerShutdownFunction) {
	...
	ZEPHIR_CALL_FUNCTION(&error, "error_get_last", NULL, 68);
	zephir_check_call_status();
	_0 = zephir_is_true(&error);
	if (_0) {
		zephir_array_fetch_string(&_1, &error, SL("type"), PH_NOISY | PH_READONLY, "leevel/bootstrap/bootstrap/registerruntime.zep", 106 TSRMLS_CC);
...
PHP_METHOD(Leevel_Bootstrap_Bootstrap_RegisterRuntime, setExceptionHandler) {
	...
	if (!(zephir_instance_of_ev(e, zend_exception_get_default(TSRMLS_C) TSRMLS_CC))) {
		...
		zephir_check_call_status();
		ZVAL_LONG(&_5$$3, 1);
		ZEPHIR_CALL_METHOD(NULL, &fatalException, "__construct", NULL, 67, &_0$$3, &_1$$3, &_5$$3, &_2$$3, &_3$$3, &_4$$3);
		zephir_check_call_status();
	} else {
...
PHP_METHOD(Leevel_Bootstrap_Bootstrap_RegisterRuntime, formatErrorException) {
	...
	zephir_array_fetch_string(&_0, &error, SL("message"), PH_NOISY | PH_READONLY, "leevel/bootstrap/bootstrap/registerruntime.zep", 177 TSRMLS_CC);
	zephir_array_fetch_string(&_1, &error, SL("type"), PH_NOISY | PH_READONLY, "leevel/bootstrap/bootstrap/registerruntime.zep", 177 TSRMLS_CC);
	zephir_array_fetch_string(&_2, &error, SL("file"), PH_NOISY | PH_READONLY, "leevel/bootstrap/bootstrap/registerruntime.zep", 177 TSRMLS_CC);
	zephir_array_fetch_string(&_3, &error, SL("line"), PH_NOISY | PH_READONLY, "leevel/bootstrap/bootstrap/registerruntime.zep", 178 TSRMLS_CC);
	ZVAL_LONG(&_4, 0);
