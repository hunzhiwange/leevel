...
PHP_METHOD(Leevel_Cache_Manager, createConnect) {
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 84, connect);
...
PHP_METHOD(Leevel_Cache_Manager, makeConnectRedis) {
	...
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 86, &tmp);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 87, &_0, &tmp);
	zephir_check_call_status();
	RETURN_MM();
