...
PHP_METHOD(Leevel_Log_Manager, createConnect) {
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 129, connect, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Leevel_Log_Manager, makeConnectFile) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 130, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Leevel_Log_Manager, makeConnectSyslog) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "normalizeconnectoption", NULL, 0, &_1, &options);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 131, &_0);
	zephir_check_call_status();
	RETURN_MM();
