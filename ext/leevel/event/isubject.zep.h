...
ZEND_BEGIN_ARG_INFO_EX(arginfo_leevel_event_isubject_register, 0, 0, 1)
	ZEND_ARG_INFO(0, observer)
ZEND_END_ARG_INFO()

ZEPHIR_INIT_FUNCS(leevel_event_isubject_method_entry) {
	PHP_ABSTRACT_ME(Leevel_Event_ISubject, register, arginfo_leevel_event_isubject_register)
	PHP_FE_END
};
