...
ZEND_BEGIN_ARG_INFO_EX(arginfo_leevel_event_subject_register, 0, 0, 1)
...
ZEPHIR_INIT_FUNCS(leevel_event_subject_method_entry) {
	...
	PHP_ME(Leevel_Event_Subject, register, arginfo_leevel_event_subject_register, ZEND_ACC_PUBLIC)
	PHP_FE_END
};
