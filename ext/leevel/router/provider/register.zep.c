...
PHP_METHOD(Leevel_Router_Provider_Register, routerClosure) {
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 134, container);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Leevel_Router_Provider_Register, cookieClosure) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 138, &_2);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Leevel_Router_Provider_Register, viewClosure) {
	...
	ZEPHIR_CALL_METHOD(&_0, container, "make", NULL, 0, &_1);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 139, &_0);
	zephir_check_call_status();
	RETURN_MM();
