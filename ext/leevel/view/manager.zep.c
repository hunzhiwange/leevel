...
PHP_METHOD(Leevel_View_Manager, createConnect) {
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 158, connect);
...
PHP_METHOD(Leevel_View_Manager, makeConnectHtml) {
	...
	ZEPHIR_CALL_METHOD(NULL, &html, "__construct", NULL, 159, &options);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, &html, "setparseresolver", NULL, 160, &parser);
	zephir_check_call_status();
	RETURN_CCTOR(&html);
...
PHP_METHOD(Leevel_View_Manager, makeConnectTwig) {
	...
	ZEPHIR_CALL_METHOD(NULL, &twig, "__construct", NULL, 159, &options);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, &twig, "setparseresolver", NULL, 161, &parser);
	zephir_check_call_status();
	RETURN_CCTOR(&twig);
...
PHP_METHOD(Leevel_View_Manager, makeConnectPhpui) {
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 159, &options);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Leevel_View_Manager, makeConnectV8js) {
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 162, &options);
	zephir_check_call_status();
	RETURN_MM();
