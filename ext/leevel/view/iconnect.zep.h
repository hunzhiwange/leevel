...
ZEND_BEGIN_ARG_INFO_EX(arginfo_leevel_view_iconnect_deletevar, 0, 0, 1)
...
ZEPHIR_INIT_FUNCS(leevel_view_iconnect_method_entry) {
	...
	PHP_ABSTRACT_ME(Leevel_View_IConnect, deleteVar, arginfo_leevel_view_iconnect_deletevar)
