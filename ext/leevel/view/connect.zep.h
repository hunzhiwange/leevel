...
ZEND_BEGIN_ARG_INFO_EX(arginfo_leevel_view_connect_deletevar, 0, 0, 1)
...
ZEPHIR_INIT_FUNCS(leevel_view_connect_method_entry) {
	...
	PHP_ME(Leevel_View_Connect, deleteVar, arginfo_leevel_view_connect_deletevar, ZEND_ACC_PUBLIC)
