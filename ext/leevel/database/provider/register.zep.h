...
ZEND_BEGIN_ARG_INFO_EX(arginfo_leevel_database_provider_register_bootstrap, 0, 0, 1)
	ZEND_ARG_OBJ_INFO(0, event, Leevel\\Event\\IDispatch, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_leevel_database_provider_register_eventdispatch, 0, 0, 1)
	ZEND_ARG_OBJ_INFO(0, event, Leevel\\Event\\IDispatch, 0)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(leevel_database_provider_register_method_entry) {
	...
	PHP_ME(Leevel_Database_Provider_Register, bootstrap, arginfo_leevel_database_provider_register_bootstrap, ZEND_ACC_PUBLIC)
	PHP_ME(Leevel_Database_Provider_Register, providers, NULL, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Leevel_Database_Provider_Register, isDeferred, NULL, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	...
	PHP_ME(Leevel_Database_Provider_Register, eventDispatch, arginfo_leevel_database_provider_register_eventdispatch, ZEND_ACC_PROTECTED)
	PHP_ME(Leevel_Database_Provider_Register, meta, NULL, ZEND_ACC_PROTECTED)
	PHP_FE_END
};
